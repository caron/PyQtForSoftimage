##
#	\namespace	python.blurdev.ide.wizards.packagewizard.packagewizard
#
#	\remarks	Defines the main Wizard class for the PackageWizard wizard system
#	
...
class PackageWizard( Wizard ):
	def initWizardPages( self ):
		...
		from packageoptions import PackageOptions
		self.addPage( PackageOptions( self ) )

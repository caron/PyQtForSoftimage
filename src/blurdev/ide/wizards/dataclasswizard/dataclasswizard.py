##
#	\namespace	python.blurdev.ide.wizards.dataclasswizard.dataclasswizard
#
#	\remarks	Defines the main Wizard class for the DataClassWizard wizard system
#	
...
class DataClassWizard( Wizard ):
	def initWizardPages( self ):
		"""
			...
			\return		<void>
		"""
		self.setWindowTitle( 'Data Class Wizard' )
		
		# create the main options page
		from dataclassoptions import DataClassOptions
		self.addPage( DataClassOptions( self ) )
